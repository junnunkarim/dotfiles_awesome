...
local rubato = require("custom_modules.rubato") -- Totally optional, only required if you are using animations.
...
scratch_btop = bling.module.scratchpad {
    command = "alacritty --class scratch_btop --config-file $HOME/.config/alacritty/alacritty_scratchpad.yml -e btop",
    rule = {
