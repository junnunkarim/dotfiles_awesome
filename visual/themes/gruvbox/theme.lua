...
theme.border_color_active = colors.blue2
...
--theme.icon_theme = os.getenv("HOME") .. "/.icons/Papirus/"
...
theme.tag_preview_client_border_color = colors.blue2 -- The border color of each client
...
theme.tag_preview_widget_border_color = colors.blue2 -- The border color of the widget
